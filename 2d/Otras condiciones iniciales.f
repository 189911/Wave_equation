...
!     encias finitas
      ...
      integer::j,i,k,intervalos,or,nx,p,ny,u,s,N_Mitad1,N_Mitad2
      character*100::z
      real*8,dimension(1000,200,200)::mat
      real*8,dimension(1,500,500)::Mitad1,Mitad2
...
c     las I y J vamos hacer I como el contador de T, J oara X y u para Y
      do i=1,intervalos
      do j=1,nx
      do u=1,ny
      mat(i,j,u)=0.0
...
c     empezamos nuestras condiciones inicales----------------------
      ...
      call Piramide(Mitad1,N_Mitad1,ny,h*N_Mitad1,L,corX1,corY1,corZ1,h)
      call Piramide(Mitad2,N_Mitad2,ny,h*N_Mitad2,L,corX2,corY2,corZ2,h)
      do j=1,nx
      do u=1,ny
      if (j.Lt.N_Mitad1)then
      mat(1,j,u)=Mitad1(1,j,u)
      else
      mat(1,j,u)=Mitad2(1,j,u)
      end if
      end do
      end do
...
# cada fotograma debe estar separado por dos espacios en blanco
      ...
      z="for [i=0:int(A_blocks-1)]{splot file1 index i w l lc 1 lw 2}"
